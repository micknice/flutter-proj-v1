...
class _CreatUpdateJobViewState extends State<CreatUpdateJobView> {
  ...
  Future<CloudJob> createOrGetExistingJob(BuildContext context) async {
    ...
    if (existingJob != null) {
      print('existingJOb');
      _jobName.text = existingJob.jobName;
      _jobType.text = existingJob.jobType;
      _jobSubType.text = existingJob.jobSubType;
    ...
    _jobs = newJob;
    _jobName.text = newJob.jobName;
    _jobType.text = newJob.jobType;
    _jobSubType.text = newJob.jobSubType;
    return newJob;
  }
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () async {
                  final resultText =
                      'Shared flow-note: ${_jobName.text} - ${_result.text}';
                  if (_jobs == null || resultText.isEmpty) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            // invoke the calcFunc when implemented
                            // calcFunc();
                          },
